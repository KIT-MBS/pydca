# About `pydca`
> [!CAUTION]
> Unfortunately, pyDCA will no longer be updated to newer versions. If you wish to continue using it, we recommend utilizing a Docker container. An example setup is shown here.
