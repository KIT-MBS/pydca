...
void PlmDCA::initFieldsAndCouplings(VectorXf& fields_and_couplings)
{
    if(fields_and_couplings.rows() > 0 && fields_and_couplings.cols() > 0){
...
float  PlmDCA::gradient(const VectorXf& fields_and_couplings, VectorXf& grad)
{
