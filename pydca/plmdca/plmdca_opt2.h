...
#define PLMDCA_BACKEND_H
    ...
    class PlmDCA {
        ...
        public:
            ...
            float gradient(VectorXf const& fields_and_couplings, VectorXf& grad);

            void initFieldsAndCouplings(VectorXf& fields_and_couplings);
            ...
            void printDCAScores(VectorXf const& h_and_J);
            int runPlmDCA();
